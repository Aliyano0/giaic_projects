...
// Game Variables
const enemies = ["Skeleton", "Zombie", "Warrior", "Assassin"]; // Enemies List 
let maxEnemyHealth = 75; // Maximum health of Enemy. It will be used with math.random to randomized health between 1-75 enemy health.
let enemyAttackDmg = 25; // Enemy attack damage will also be used with math.random for random attack dmg between 0-25 dmg.
// Player Variables
let health = 100; // Player Health
let attackDmg = 50; // Attack Damage will be used with math.random for random attack damage between 0-50 dmg.
let numHealthPotions = 3; // Max Health Potions
let healthPotionHealAmount = 30; // Health potion's health 
        ...
        // If player selects drink health potion.
            ...
            if (numHealthPotions > 0) {
                if (health === 100) {
                    ...
                    numHealthPotions--;
                    console.log(chalk.blue(`\t> You drink a health potion, healing yourself for ${healthPotionHealAmount}.`), chalk.green(`\n\t> You now have ${health} HP.`), chalk.yellow(`\n\t> You have ${numHealthPotions} health potions left.\n`));
                }
            }

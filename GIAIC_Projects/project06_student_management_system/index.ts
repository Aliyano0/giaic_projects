...
while (condition) {
  ...
  class StudentManagementSystem implements StudentInfo{
    readonly studentName: string
    readonly email: string; 
    readonly studentID: number
    course?: string
    ...
    constructor(studentName: string, email: string) {
    ...
    // TUITION FEES
    payTuitionFees(paymentMethod: string, paymentAmount: number) {
